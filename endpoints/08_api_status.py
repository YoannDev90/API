...
async def status_check():
    try:
        ...
        return {"code": str(resp.status_code), "service": "API Proxy", "data_service": "Service indisponible"}
    except httpx.TimeoutException:
        return {"code": "503", "service": "API Proxy", "data_service": "Timeout"}
    except httpx.ConnectError:
        return {"code": "503", "service": "API Proxy", "data_service": "Service indisponible"}
