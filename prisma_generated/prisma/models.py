...
class LiteLLM_BudgetTable(bases.BaseLiteLLM_BudgetTable):
    ...
    @field_validator('allowed_models', pre=True, allow_reuse=True)
    @classmethod
...
class LiteLLM_TeamTable(bases.BaseLiteLLM_TeamTable):
    ...
    policies: List[_str]
    default_team_member_models: List[_str]
    budget_limits: Optional['fields.Json'] = None
    ...
    @field_validator('admins', 'members', 'models', 'team_member_permissions', 'access_group_ids', 'policies', 'default_team_member_models', pre=True, allow_reuse=True)
    @classmethod
    def _transform_required_list_fields(cls, value: object) -> object:
        # When using raw queries, some databases will return `None` for an array field that has not been set yet.
        #
...
class LiteLLM_ObjectPermissionTable(bases.BaseLiteLLM_ObjectPermissionTable):
    ...
    mcp_toolsets: List[_str]
    search_tools: List[_str]
    mcp_tool_search_enabled: Optional[_bool] = None
    teams: Optional[List['models.LiteLLM_TeamTable']] = None
    projects: Optional[List['models.LiteLLM_ProjectTable']] = None
    ...
    @field_validator('mcp_servers', 'mcp_access_groups', 'vector_stores', 'agents', 'agent_access_groups', 'models', 'blocked_tools', 'mcp_toolsets', 'search_tools', pre=True, allow_reuse=True)
    @classmethod
    def _transform_required_list_fields(cls, value: object) -> object:
        # When using raw queries, some databases will return `None` for an array field that has not been set yet.
        #
...
class LiteLLM_MCPServerTable(bases.BaseLiteLLM_MCPServerTable):
    ...
    extra_headers: List[_str]
    static_headers: Optional['fields.Json'] = None
    env_vars: Optional['fields.Json'] = None
    ...
    oauth2_flow: Optional[_str] = None
    allow_all_keys: _bool
    available_on_public_internet: _bool
    delegate_auth_to_upstream: _bool
    oauth_passthrough: _bool
    is_byok: _bool
    byok_description: List[_str]
    byok_api_key_help_url: Optional[_str] = None
    source_url: Optional[_str] = None
    timeout: Optional[_float] = None
    max_concurrent_requests: Optional[_int] = None
    approval_status: Optional[_str] = None
    submitted_by: Optional[_str] = None
    submitted_at: Optional[datetime.datetime] = None
    reviewed_at: Optional[datetime.datetime] = None
    review_notes: Optional[_str] = None
...
class LiteLLM_MCPToolsetTable(bases.BaseLiteLLM_MCPToolsetTable):
    """Represents a LiteLLM_MCPToolsetTable record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_MCPToolsetTableKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_MCPToolsetTableKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_MCPToolsetTableKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_MCPToolsetTableKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_MCPToolsetTableRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_MCPToolsetTableKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_MCPToolsetTable_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_MCPToolsetTable_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_MCPToolsetTable_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if relations:
                raise ValueError('Model: "LiteLLM_MCPToolsetTable" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_MCPToolsetTable / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_MCPToolsetTable',
            }
        )
        _created_partial_types.add(name)
...
class LiteLLM_MCPUserEnvVars(bases.BaseLiteLLM_MCPUserEnvVars):
    """Represents a LiteLLM_MCPUserEnvVars record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_MCPUserEnvVarsKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_MCPUserEnvVarsKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_MCPUserEnvVarsKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_MCPUserEnvVarsKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_MCPUserEnvVarsRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_MCPUserEnvVarsKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_MCPUserEnvVars_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_MCPUserEnvVars_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_MCPUserEnvVars_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if relations:
                raise ValueError('Model: "LiteLLM_MCPUserEnvVars" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_MCPUserEnvVars / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_MCPUserEnvVars',
            }
        )
        _created_partial_types.add(name)
...
class LiteLLM_MemoryTable(bases.BaseLiteLLM_MemoryTable):
    """Represents a LiteLLM_MemoryTable record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_MemoryTableKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_MemoryTableKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_MemoryTableKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_MemoryTableKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_MemoryTableRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_MemoryTableKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_MemoryTable_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_MemoryTable_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_MemoryTable_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if relations:
                raise ValueError('Model: "LiteLLM_MemoryTable" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_MemoryTable / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_MemoryTable',
            }
        )
        _created_partial_types.add(name)


class LiteLLM_AdaptiveRouterState(bases.BaseLiteLLM_AdaptiveRouterState):
    """Represents a LiteLLM_AdaptiveRouterState record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_AdaptiveRouterStateKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_AdaptiveRouterStateKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_AdaptiveRouterStateKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_AdaptiveRouterStateKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_AdaptiveRouterStateRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_AdaptiveRouterStateKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_AdaptiveRouterState_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_AdaptiveRouterState_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_AdaptiveRouterState_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if relations:
                raise ValueError('Model: "LiteLLM_AdaptiveRouterState" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_AdaptiveRouterState / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_AdaptiveRouterState',
            }
        )
        _created_partial_types.add(name)


class LiteLLM_AdaptiveRouterSession(bases.BaseLiteLLM_AdaptiveRouterSession):
    """Represents a LiteLLM_AdaptiveRouterSession record"""

    session_id: _str
    router_name: _str
    model_name: _str
    classified_type: _str
    misalignment_count: _int
    stagnation_count: _int
    disengagement_count: _int
    satisfaction_count: _int
    failure_count: _int
    loop_count: _int
    exhaustion_count: _int
    last_user_content: Optional[_str] = None
    last_assistant_content: Optional[_str] = None
    tool_call_history: 'fields.Json'
    pending_tool_calls: 'fields.Json'
    turn_count: _int
    last_processed_turn: _int
    clean_credit_awarded: _bool
    terminal_status: Optional[_int] = None
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_AdaptiveRouterSessionKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_AdaptiveRouterSessionKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_AdaptiveRouterSessionKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_AdaptiveRouterSessionKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_AdaptiveRouterSessionRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_AdaptiveRouterSessionKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_AdaptiveRouterSession_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_AdaptiveRouterSession_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_AdaptiveRouterSession_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if relations:
                raise ValueError('Model: "LiteLLM_AdaptiveRouterSession" has no relational fields.')
        except KeyError as exc:
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_AdaptiveRouterSession / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_AdaptiveRouterSession',
            }
        )
        _created_partial_types.add(name)


class LiteLLM_WorkflowRun(bases.BaseLiteLLM_WorkflowRun):
    """Represents a LiteLLM_WorkflowRun record"""
    ...
    created_at: datetime.datetime
    updated_at: datetime.datetime
    input: Optional['fields.Json'] = None
    output: Optional['fields.Json'] = None
    metadata: Optional['fields.Json'] = None
    events: Optional[List['models.LiteLLM_WorkflowEvent']] = None
    messages: Optional[List['models.LiteLLM_WorkflowMessage']] = None
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_WorkflowRunKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_WorkflowRunKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_WorkflowRunKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_WorkflowRunKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_WorkflowRunRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_WorkflowRunKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_WorkflowRun_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_WorkflowRun_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_WorkflowRun_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _LiteLLM_WorkflowRun_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _LiteLLM_WorkflowRun_relational_fields:
                        raise errors.UnknownRelationalFieldError('LiteLLM_WorkflowRun', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_WorkflowRun / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_WorkflowRun',
            }
        )
        _created_partial_types.add(name)


class LiteLLM_WorkflowEvent(bases.BaseLiteLLM_WorkflowEvent):
    """Represents a LiteLLM_WorkflowEvent record"""
    ...
    created_at: datetime.datetime
    run: Optional['models.LiteLLM_WorkflowRun'] = None
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_WorkflowEventKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_WorkflowEventKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_WorkflowEventKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_WorkflowEventKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_WorkflowEventRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_WorkflowEventKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_WorkflowEvent_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_WorkflowEvent_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_WorkflowEvent_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _LiteLLM_WorkflowEvent_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _LiteLLM_WorkflowEvent_relational_fields:
                        raise errors.UnknownRelationalFieldError('LiteLLM_WorkflowEvent', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_WorkflowEvent / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_WorkflowEvent',
            }
        )
        _created_partial_types.add(name)


class LiteLLM_WorkflowMessage(bases.BaseLiteLLM_WorkflowMessage):
    """Represents a LiteLLM_WorkflowMessage record"""
    ...
    def create_partial(
        name: str,
        include: Optional[Iterable['types.LiteLLM_WorkflowMessageKeys']] = None,
        exclude: Optional[Iterable['types.LiteLLM_WorkflowMessageKeys']] = None,
        required: Optional[Iterable['types.LiteLLM_WorkflowMessageKeys']] = None,
        optional: Optional[Iterable['types.LiteLLM_WorkflowMessageKeys']] = None,
        relations: Optional[Mapping['types.LiteLLM_WorkflowMessageRelationalFieldKeys', str]] = None,
        exclude_relational_fields: bool = False,
    ) -> None:
        if not os.environ.get('PRISMA_GENERATOR_INVOCATION'):
            raise RuntimeError(
        ...
        fields: Dict['types.LiteLLM_WorkflowMessageKeys', PartialModelField] = OrderedDict()

        try:
            if include:
                for field in include:
                    fields[field] = _LiteLLM_WorkflowMessage_fields[field].copy()
            elif exclude:
                for field in exclude:
                    if field not in _LiteLLM_WorkflowMessage_fields:
                        raise KeyError(field)

                fields = {
                    key: data.copy()
                    for key, data in _LiteLLM_WorkflowMessage_fields.items()
                    if key not in exclude
                }
            else:
                fields = {
            ...
            if exclude_relational_fields:
                fields = {
                    key: data
                    for key, data in fields.items()
                    if key not in _LiteLLM_WorkflowMessage_relational_fields
                }

            if relations:
                for field, type_ in relations.items():
                    if field not in _LiteLLM_WorkflowMessage_relational_fields:
                        raise errors.UnknownRelationalFieldError('LiteLLM_WorkflowMessage', field)
            ...
            raise ValueError(
                f'{exc.args[0]} is not a valid LiteLLM_WorkflowMessage / {name} field.'
            ) from None
        ...
        models.append(
            {
                'name': name,
                'fields': cast(Mapping[str, PartialModelField], fields),
                'from_model': 'LiteLLM_WorkflowMessage',
            }
        )
        _created_partial_types.add(name)
...
_LiteLLM_MCPToolsetTable_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
_LiteLLM_MCPToolsetTable_fields: Dict['types.LiteLLM_MCPToolsetTableKeys', PartialModelField] = OrderedDict(
    [
        ('toolset_id', {
            'name': 'toolset_id',
            'is_list': False,
...
_LiteLLM_MCPUserEnvVars_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
_LiteLLM_MCPUserEnvVars_fields: Dict['types.LiteLLM_MCPUserEnvVarsKeys', PartialModelField] = OrderedDict(
    [
        ('id', {
            'name': 'id',
            'is_list': False,
...
_LiteLLM_MemoryTable_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
_LiteLLM_MemoryTable_fields: Dict['types.LiteLLM_MemoryTableKeys', PartialModelField] = OrderedDict(
    [
        ('memory_id', {
            'name': 'memory_id',
            'is_list': False,
...
_LiteLLM_AdaptiveRouterState_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
_LiteLLM_AdaptiveRouterState_fields: Dict['types.LiteLLM_AdaptiveRouterStateKeys', PartialModelField] = OrderedDict(
    [
        ('router_name', {
            'name': 'router_name',
            'is_list': False,
...
_LiteLLM_AdaptiveRouterSession_relational_fields: Set[str] = set()  # pyright: ignore[reportUnusedVariable]
_LiteLLM_AdaptiveRouterSession_fields: Dict['types.LiteLLM_AdaptiveRouterSessionKeys', PartialModelField] = OrderedDict(
    [
        ('session_id', {
            'name': 'session_id',
            'is_list': False,
...
_LiteLLM_WorkflowRun_relational_fields: Set[str] = {
        'events',
        'messages',
    }
_LiteLLM_WorkflowRun_fields: Dict['types.LiteLLM_WorkflowRunKeys', PartialModelField] = OrderedDict(
    [
        ('run_id', {
            'name': 'run_id',
            'is_list': False,
        ...
        ('events', {
            ...
            'is_list': True,
            'optional': True,
            'type': 'List[\'models.LiteLLM_WorkflowEvent\']',
            'is_relational': True,
            'documentation': None,
        }),
        ('messages', {
            ...
            'is_list': True,
            'optional': True,
            'type': 'List[\'models.LiteLLM_WorkflowMessage\']',
            'is_relational': True,
            'documentation': None,
        }),
    ],
...
_LiteLLM_WorkflowEvent_relational_fields: Set[str] = {
        'run',
    }
_LiteLLM_WorkflowEvent_fields: Dict['types.LiteLLM_WorkflowEventKeys', PartialModelField] = OrderedDict(
    [
        ('event_id', {
            'name': 'event_id',
            'is_list': False,
        ...
        ('run', {
            ...
            'is_list': False,
            'optional': True,
            'type': 'models.LiteLLM_WorkflowRun',
            'is_relational': True,
            'documentation': None,
        }),
    ],
...
_LiteLLM_WorkflowMessage_relational_fields: Set[str] = {
        'run',
    }
_LiteLLM_WorkflowMessage_fields: Dict['types.LiteLLM_WorkflowMessageKeys', PartialModelField] = OrderedDict(
    [
        ('message_id', {
            'name': 'message_id',
            'is_list': False,
...
model_rebuild(LiteLLM_MCPToolsetTable)
model_rebuild(LiteLLM_MCPUserCredentials)
model_rebuild(LiteLLM_MCPUserEnvVars)
...
model_rebuild(LiteLLM_MemoryTable)
model_rebuild(LiteLLM_AdaptiveRouterState)
model_rebuild(LiteLLM_AdaptiveRouterSession)
model_rebuild(LiteLLM_WorkflowRun)
model_rebuild(LiteLLM_WorkflowEvent)
model_rebuild(LiteLLM_WorkflowMessage)
